...
system("echo n=80 m=-1 chain | ./mkr > 3.in")
system("echo n=80 m=40 chain | ./mkr > 4.in")
system("echo n=80 m=80 chain | ./mkr > 5.in")
system("echo n=300 m=233 chain | ./mkr > 6.in")
system("echo n=300 m=10000 chain | ./mkr > 7.in")
system("echo n=80 m=-1 | ./mkr > 8.in")
system("echo n=80 m=80 | ./mkr > 9.in")
system("echo n=300 m=-1 | ./mkr > 10.in")
system("echo n=300 m=-1 | ./mkr > 11.in")
system("echo n=300 m=-1 | ./mkr > 12.in")
